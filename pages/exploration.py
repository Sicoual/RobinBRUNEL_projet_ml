...
def app():
    ...
    if 'feature_names' in st.session_state:
        # Exclure 'id' de la liste des features
        features = [col for col in st.session_state['feature_names'] if col != 'id']
        ...
        if valider:
            ...
            # Réindexer sans la colonne 'id'
            expected_cols = [col for col in X_test.columns if col != 'id']
            if set(expected_cols) != set(input_df_encoded.columns):
